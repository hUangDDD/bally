...
function build() {
    ...
    `;*/
    return { body: body, css: css, javascript: javascript };
}
//这个是游戏相关的内容
...
function concat(arr) {
    let ret = arr.map(name => { return fs.readFileSync(name, 'utf8'); });
    return ret.join("\r\n");
}
function safeBuild() {
...
function getWebWorkerJavascript() {
    return webworker_result;
}
exports.getWebWorkerJavascript = getWebWorkerJavascript;
